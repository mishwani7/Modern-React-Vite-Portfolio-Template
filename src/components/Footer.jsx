  ...
  return (
    <footer className="footer">
      <div className="footer-content">
        <span className="footer-comment">//</span>        <span>
          Built with{" "}
          <svg
            className="react-svg"
